...
| Voice license (en_US-joe-medium) | **Dataset CC0** (OHF-Voice/voice-datasets). 1 speaker, 22,050 Hz. Finetuned from U.S. English lessac. Most permissive English option — baseline for English evaluation. | https://huggingface.co/rhasspy/piper-voices/blob/main/en/en_US/joe/medium/MODEL_CARD |
| Voice license (en_US-kristin-medium) | **Dataset public domain** (LibriVox recordings). 1 speaker, 22,050 Hz, female. Trained from scratch. Permissive — selected as English candidate. | https://huggingface.co/rhasspy/piper-voices/blob/main/en/en_US/kristin/medium/MODEL_CARD |
| Voice license (en_US-ljspeech-medium) | **Dataset public domain** (LJSpeech). 1 speaker, 22,050 Hz, female. Trained from scratch. Permissive — selected as English candidate. | https://huggingface.co/rhasspy/piper-voices/blob/main/en/en_US/ljspeech/medium/MODEL_CARD |
| Voice license (en_US-amy-medium) | mimic3-voices repo is **CC-BY-SA-4.0** — share-alike; not selected for commercial suitability. | https://github.com/MycroftAI/mimic3-voices |
| Voice license (en_US-hfc_female-medium) | **Dataset CC BY-NC-SA 4.0** (Hi-Fi Captain) — **non-commercial**, rejected. | https://huggingface.co/rhasspy/piper-voices/blob/main/en/en_US/hfc_female/medium/MODEL_CARD |
| Voice license (en_US-ryan-medium) | **Dataset CC BY-NC-SA 4.0** (RyanSpeech on Kaggle) — **non-commercial**, rejected for a commercial product. | https://huggingface.co/rhasspy/piper-voices/blob/main/en/en_US/ryan/medium/MODEL_CARD |
| Voice license (en_US-lessac-medium) | **Research-only license** (Lessac/Blizzard 2013, Voice Factory Intl.) — explicitly excludes commercial voice synthesis products. Rejected for commercial use. | https://www.cstr.ed.ac.uk/projects/blizzard/2013/lessac_blizzard2013/license.html |
| Dataset restrictions | chitwan + joe: **CC0**. kristin + ljspeech: **public domain**. google-medium / google-x_low: **CC-BY-SA-4.0** (share-alike). | per-voice MODEL_CARDs (above) |
| Commercial use       | GPL-3.0 code: copyleft obligations for distribution. Voice models: chitwan + joe **CC0**, kristin + ljspeech **public domain**; google voices **CC-BY-SA-4.0** (share-alike). **No legal conclusion.** | — |
